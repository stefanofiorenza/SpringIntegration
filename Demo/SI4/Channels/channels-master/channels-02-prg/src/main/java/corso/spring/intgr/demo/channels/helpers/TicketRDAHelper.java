...
public class TicketRDAHelper {
	...
	private static Logger logger = Logger.getLogger(TicketRDAHelper.class);
	...
	public static TicketRDA createTicket() {
		...
		logger.debug("[TicketRDAHelper]: produce Ticket: "+nuovoTicket.toString());
		return nuovoTicket;
	}
